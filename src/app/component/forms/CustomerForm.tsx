    ...
    <div className='w-[60vw] mx-auto'>
        ...
        <h3 className='font-medium text-[24px] mt-3 mb-2'>Personal Details</h3>
          ...
          {/* <div className='grid grid-cols-2 gap-4'>
            ...
            {errors.nextOfKin?.fullName && <p role="alert">Full name is required</p>}

            <div className='formDiv' >
                <label htmlFor="">Relationship</label>
                <input {...register('nextOfKin.relationship',{required:true})} className='input' type="text" />
            </div>
            {errors.nextOfKin?.relationship && <p role="alert">Relationship is required</p>}

            <div className='formDiv' >
                <label htmlFor="">Phone number</label>
                <input {...register('nextOfKin.phoneNumber')} className='input' type="text" />
            </div>
            {errors.nextOfKin?.phoneNumber && <p role="alert">Phone number is required</p>}

            <div className='formDiv' >
                <label htmlFor="">Address</label>
                <input {...register('nextOfKin.address',{required:true})} className='input' type="text" />
            </div>
            {errors.nextOfKin?.address && <p role="alert">Address is required</p>}
          ...
          {/* <div className='grid grid-cols-2 gap-4'>
            ...
            {errors.employmentInfo?.employmentStatus && <p role="alert">Employment status is required</p>}

            <div className='formDiv' >
                <label htmlFor="">Employer name</label>
                <input {...register('employmentInfo.employerName',{required:true})} className='input' type="text" />
            </div>
            {errors.employmentInfo?.employerName && <p role="alert">Employer name is required</p>}
            ...
            {errors.employmentInfo?.employerAddress && <p role="alert">Employer address is required</p>}
            ...
            {errors.employmentInfo?.employmentDuration && <p role="alert">Employment duration is required</p>}

            <div className='formDiv' >
                <label htmlFor="">Membership type</label>
                <input {...register('membershipType',{required:true})} className='input' type="text" />
            </div>
            {errors.membershipType && <p role="alert">Membership type is required</p>}

            <div className='formDiv' >
                <label htmlFor="">Start Date</label>
                <input {...register('startDate',{required:true})} className='input' type="date" />
            </div>
            {errors.startDate && <p role="alert">Start date is required</p>}
            ...
            {errors.membershipID && <p role="alert">Membership Id is required</p>}
